...
def create_data(file_list, type):
    ...
    # i = 1
    with open(os.path.join(f"data/sample_data/new_data/{type}.csv"), "w", newline="", encoding="utf-8") as myFile:
...
if __name__ == "__main__":
    file_list = glob.glob(os.path.join("data/sample_data/raw_data/train", "*.txt"))
